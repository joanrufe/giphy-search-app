...
function GiphySearch({ location = { search: "" } } = {}) {
  ...
  const { error, loading, data, pagination, fetchGifs, query } = useGiphyApi(
    initialQuery
  );
  ...
  return (
    <Layout>
      ...
      <Content style={{ width: "100%" }}>
        <Form
          onSubmit={onSubmit}
          style={{ margin: "20px auto 20px auto", maxWidth: "250px" }}
        >
        ...
        {!loading && !error && pagination && pagination.total_count === 0 && (
